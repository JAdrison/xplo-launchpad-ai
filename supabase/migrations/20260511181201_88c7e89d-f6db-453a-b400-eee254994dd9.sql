-- Add periodicity to traffic payment config
ALTER TABLE public.clients
  ADD COLUMN IF NOT EXISTS traffic_payment_recurrence_days integer NOT NULL DEFAULT 30;

-- Update sync function to use recurrence_days and compute next due based on it
...
-- Update completion trigger to honor recurrence_days
